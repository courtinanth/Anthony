...
const PAGES = [
  ...
  { frag: 'seo.html', out: 'seo.html', url: '/seo',
    ...
    desc: "Audit, SEO technique, netlinking et SEO local : une méthode mesurée pour gagner des positions durables sur Google. Consultant indépendant, partout en France.",
    crumb: 'SEO',
    service: { name: 'SEO : audit, technique, netlinking, SEO local', type: 'Search engine optimization' } },
  { frag: 'geo.html', out: 'geo.html', url: '/geo',
    title: 'Consultant GEO : visibilité IA (ChatGPT, Perplexity) | Anthony Courtin',
  ...
  { frag: 'automatisation-ia.html', out: 'automatisation-ia.html', url: '/automatisation-ia',
    title: 'Automatisation IA : agents, workflows, contenu | Anthony Courtin',
    desc: "Agents IA, workflows n8n et Make, pipelines de contenu : automatisez vos process marketing et gagnez des dizaines d'heures par mois, mesurées.",
    crumb: 'Automatisation IA',
    service: { name: 'Automatisation IA : agents, workflows, pipelines', type: 'Marketing automation' } },
  /* ---- sous-pages SEO ---- */
  { frag: 'audit-seo.html', out: 'audit-seo.html', url: '/audit-seo',
    title: "Audit SEO complet avec plan d'action priorisé | Anthony Courtin",
    desc: "Audit SEO technique, sémantique et popularité, livré avec un plan d'action priorisé par impact et une restitution en visio. Devis gratuit, partout en France.",
    crumb: 'Audit SEO', parent: { name: 'SEO', url: '/seo' },
    service: { name: 'Audit SEO complet', type: 'Search engine optimization audit' } },
  { frag: 'seo-technique.html', out: 'seo-technique.html', url: '/seo-technique',
    title: 'SEO technique : crawl, indexation, Core Web Vitals | Anthony Courtin',
    desc: "Crawl, indexation, vitesse, données structurées : un site que Google et les crawlers IA comprennent parfaitement. Spécifications ou implémentation directe.",
    crumb: 'SEO technique', parent: { name: 'SEO', url: '/seo' },
    service: { name: 'SEO technique', type: 'Technical SEO' } },
  { frag: 'netlinking.html', out: 'netlinking.html', url: '/netlinking',
    title: 'Netlinking : backlinks de qualité, autorité durable | Anthony Courtin',
    desc: "Acquisition propre de liens éditoriaux thématiques : audit de profil, sélection manuelle des spots, reporting transparent. Sans risque de pénalité.",
    crumb: 'Netlinking', parent: { name: 'SEO', url: '/seo' },
    service: { name: 'Netlinking', type: 'Link building' } },
  { frag: 'seo-local.html', out: 'seo-local.html', url: '/seo-local',
    title: 'SEO local : Google Business Profile, avis, pack local | Anthony Courtin',
  ...
  /* ---- sous-pages GEO ---- */
  { frag: 'strategie-geo.html', out: 'strategie-geo.html', url: '/strategie-geo',
    title: 'Stratégie GEO : être recommandé par les IA | Anthony Courtin',
    desc: "Fondations techniques, autorité externe et mesure mensuelle de votre part de voix : la stratégie complète pour être cité par ChatGPT, Perplexity et Gemini.",
    crumb: 'Stratégie GEO', parent: { name: 'GEO', url: '/geo' },
    service: { name: 'Stratégie GEO', type: 'Generative engine optimization' } },
  { frag: 'audit-visibilite-ia.html', out: 'audit-visibilite-ia.html', url: '/audit-visibilite-ia',
    title: 'Audit de visibilité IA : ChatGPT, Perplexity, Gemini | Anthony Courtin',
  ...
  { frag: 'contenu-citable.html', out: 'contenu-citable.html', url: '/contenu-citable',
    title: 'Contenu citable : rédiger pour Google et les IA | Anthony Courtin',
    desc: "Réponses directes, données sourcées, structure limpide : des contenus que Google classe et que ChatGPT et Perplexity citent. Optimisation et production.",
    crumb: 'Contenu citable', parent: { name: 'GEO', url: '/geo' },
    service: { name: 'Contenu citable', type: 'Content optimization' } },
  /* ---- sous-pages Automatisation ---- */
  { frag: 'agents-ia.html', out: 'agents-ia.html', url: '/agents-ia',
    title: 'Agents IA : veille, leads, briefs automatisés | Anthony Courtin',
    desc: "Des agents IA qui exécutent de vraies tâches sous supervision humaine : veille concurrentielle, qualification de leads, briefs. Garde-fous intégrés.",
    crumb: 'Agents IA', parent: { name: 'Automatisation IA', url: '/automatisation-ia' },
    service: { name: 'Agents IA', type: 'AI agents' } },
  { frag: 'workflows.html', out: 'workflows.html', url: '/workflows',
    title: 'Workflows automatisés : n8n, Make, Zapier | Anthony Courtin',
    desc: "Cartographie de vos tâches répétitives, construction de workflows robustes et transmission à vos équipes : vos outils enfin connectés entre eux.",
    crumb: 'Workflows', parent: { name: 'Automatisation IA', url: '/automatisation-ia' },
    service: { name: 'Workflows automatisés', type: 'Workflow automation' } },
  { frag: 'pipeline-contenu.html', out: 'pipeline-contenu.html', url: '/pipeline-contenu',
    title: 'Pipeline de contenu IA : produire plus, mieux | Anthony Courtin',
    desc: "Veille, briefs, rédaction assistée et déclinaison multi-canaux avec relecture humaine : multipliez votre production de contenu sans diluer votre marque.",
    crumb: 'Pipeline de contenu', parent: { name: 'Automatisation IA', url: '/automatisation-ia' },
    service: { name: 'Pipeline de contenu IA', type: 'Content automation' } },
  /* ---- pages transverses ---- */
